...
try
{
	...
	else if(category.equals("4"))
	{
		...
		{
			System.out.println("delete from tourWicket where tourId="+tourId+" and mid="+mid+" and wno="+id+" and turn="+ttId+";");
			DB.insert("delete from tourWicket where tourId="+tourId+" and mid="+mid+" and wno="+id+" and turn="+ttId+";");
			System.out.println("tour wicket deleted succesffully");
		}
	}
...
{
	System.out.println("in updatedeletehmrSerc.java "+e);
}
%>
</body>
</html>