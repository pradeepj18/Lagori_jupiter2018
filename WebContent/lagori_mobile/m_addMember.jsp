			...
			<div class="col-xs-12 col-sm-12 col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading tournext-panel-heading center">ADD
						PLAYER DETAILS</div>
					<div class="panel-body tournext-panel-body" style="height:450px;">

						<form action="../m_addMember" method="post"
							enctype="multipart/form-data">
							<div class="row">
								<label for="tournament_name"
									class="col-md-6 col-xs-12 col-sm-6 col-form-label"
									id="tournamentlabel">First Name</label>
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input type="text" class="form-control" name="fname"
										placeholder="First Name" autofocus required id="aa">
								</div>
							</div>
							...
							<div class="row">
								<label for="tournament_name"
									class="col-md-6 col-xs-12 col-sm-6 col-form-label"
									id="tournamentlabel">Middle Name</label>
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input type="text" class="form-control" name="mname"
										placeholder="middle Name" id="aa">
								</div>
							</div>
							<div class="row">
								<label for="tournament_name"
									class="col-md-6 col-xs-12 col-sm-6 col-form-label"
									id="tournamentlabel">Last Name</label>
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input type="text" class="form-control" name="lname"
										placeholder="Last Name" required id="aa">
								</div>
							</div>
							<div class="row">
								<label for="tournament_sdate"
									class="col-md-6 col-xs-12 col-sm-6 col-form-label"
									id="tournamentlabel">Date of Birth</label>
								<div class="col-md-6 col-xs-12 col-sm-6">
									<input type="text" class="form-control aaa" name="toursdate"
										placeholder="Date of birth" id="example1">
								</div>
							...
							<div class="row">
								<label for="tournament_edate"
									class="col-md-6 col-xs-12 col-sm-6 col-form-label"
									id="tournamentlabel">Gender</label>
								<div class="col-md-6 col-xs-12 col-sm-6">
									<label class="radio-inline"> <input type="radio"
										name="gen0" required value="M" id="male">Male
									</label> <label class="radio-inline"> <input type="radio"
										name="gen0" required value="F" id="female">Female
									</label>
								</div>
							</div>
							...
							<div class="row">
								<label for="tournament_logo"
									class="col-md-6 col-xs-12 col-sm-6 col-form-label tourlogo">Player Photo</label>
								<div class="col-md-6 col-xs-12 col-sm-6">
