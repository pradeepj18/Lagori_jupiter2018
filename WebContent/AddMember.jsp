		...
		<nav class="navbar navbar-inverse" style="background-color:#2045a5;opacity:0.9;" >
			<div class="container-fluid" >
				...
				<li style="margin-left:-120px"><a href="home.jsp"><font color="white">HOME</font></a></li>
					...
					<li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="selectMatch.jsp" style="padding:16px;">SELECT MATCH <span class="sr-only">(current)</span></a></li>
...
<div class="member-container">
	...
	<div class="row">
		<div class="input_fields_wrap">
			<div class="col-md-6 col-xs-6" id="first">
				 <div class="form-group">
			   		  <label for="fname"><font size="2">First Name</font></label>
			    	  <input type="text" class="form-control" name="fname" style="height:30px;" id="fname" autofocus required placeholder="First Name">
			    </div>
			</div>
			<div class="col-md-6 col-xs-6" id="middle">
				 <div class="form-group">
			      <label for="mname"><font size="2">Middle Name</font></label>
			      <input type="text" class="form-control" id="mname"  style="height:30px;" name="mname" placeholder="Middle Name">
			    </div>
			</div>
			<div class="col-md-6 col-xs-6" id="last">
				 <div class="form-group">
			      <label for="lname"><font size="2">Last Name:</font></label>
			      <input type="text" class="form-control" style="height:30px;"  id="lname" name="lname" required placeholder="Last Name">
			    </div>
			</div>
			<div class="col-md-6 col-xs-6" id="date">
				 <div class="form-group">
			      <label for="dob"><font size="2">DOB:</font></label>
			      <input type="text" class="form-control" id="example1" name="dob"  style="height:30px;"  placeholder="DOB">
			    </div>
			    
			</div>
			<div class="col-md-6 col-xs-12" id="gender">
				<div class="form-group row">
					<label for="gender"><font size="2">Gender:</font></label><br>
				      	<label class="radio-inline">
	    			    	<input type="radio" name="gen0" required value="M" id="male">Male
	    				</label>
	    				<label class="radio-inline">
	   						<input type="radio" name="gen0" required value="F" id="female">Female
	   					</label>	
				</div>
			</div>
			<div class="col-md-3 col-xs-6" id="photo">
				 <div class="form-group">
			      ...
			      <input type="file" class="form-control"  name="photo" style="height:40px;"  onchange="readURL(this);" size="5" placeholder="select photo" autofocus id="year">
			    </div>
			</div>
			
			<div class="col-md-3 col-xs-6" id="showphoto">
				 <div class="form-group">
					<label for="team_name"><font size="2">Ur Photo</font></label>
						 <img id="blah" src="#" width="1" height="5" style="boder-radius:0px;" />
				 </div>
			</div>
			</div>
		</div>
...
<div class="row">
<div class="col-md-6 col-xs-6" id="add">
	<div class="form-group row">
